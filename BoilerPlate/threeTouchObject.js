...
{	
	...
	updateTOFArray = function(TOFData)
	{
		...
		*/
		...
		var anngularIncrement=90, tofIndex=0, tofDataIndex=1, invertIndex=0;
		//test
		for(tofDataIndex=0; tofDataIndex<4; tofDataIndex++)
		{
			tofIndex = 360-Math.round( ((tofDataIndex)*anngularIncrement)+Math.floor(TOFData[0]) )%360;
			this.TOFArray[ tofIndex ] = TOFData[4-tofDataIndex];
		}
	}
...
export default threeTouchObject;