	...
	animate = function(colourControls, controlData, rotationalIncrements=[0,0,0])
	{
		...
		for(objectIndex=0; objectIndex<this.pollyCount; objectIndex++)
		{
			for(partIndex=0; partIndex<this.objectTape[objectIndex].objects.length; partIndex++)
			{
				...
				this.objectTape[objectIndex].objects[partIndex].position.y = currentDepth;
	...
	insertObject = function()
	{
		...
		for(objectIndex=0; objectIndex<this.pollyCount; objectIndex++)
		{
			...
			for(partIndex=0; partIndex<totalPollys; partIndex++)
			{
				...
				//shift the geomtery UP for rotation to NOT BE around teh central AXIS
				this.objectTape[objectIndex].geometry[partIndex].rotateX(this.angleToRadian( 90 ));
				this.objectTape[objectIndex].geometry[partIndex].translate( 0, this.tubeRadius, 0 );
				//Material
			...
			localGroup.rotateX(this.angleToRadian( ((360/this.pollyCount)*objectIndex) ) );
